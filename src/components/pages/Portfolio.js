      ...
      <div className="row">
        ...
        <div className="card" style={styles.PortfolioStyle}>
          <a href="https://text-edit-pro.herokuapp.com/">
            ...
            <div className="card-body">
              <img src={TextEditPro} className="img-fluid"></img>
            </div>
          </a>
        </div>
        <div className="card" style={styles.PortfolioStyle}>
          <a href="https://jbungurait.github.io/My-Weather-Dashboard/">
            ...
            <div className="card-body">
              <img src={WeatherDashboard} className="img-fluid"></img>
            </div>
          </a>
        </div>
      </div>
      <div className="row">
        <div className="card" style={styles.PortfolioStyle}>
          <a href="https://github.com/jbungurait/README_Generator">
            ...
            <div className="card-body">
              <img src={READMEGen} className="img-fluid"></img>
            </div>
          </a>
        </div>
      <div className="card" style={styles.PortfolioStyle}>
        <a href="https://github.com/kylearmour1/StreamVerse">
          ...
          <div className="card-body">
            <img src={StreamVerse} className="img-fluid"></img>
          </div>
        </a>
      </div>
        {/* <div className="card" style={styles.PortfolioStyle}>
          ...
          <div className="card-body">
          <img src={SleepSync} className="img-fluid"></img>
          </div>
          </a>
        </div> */}
        </div>
